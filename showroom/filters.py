...
#         field_name="showroom__is_available", lookup_expr="exact"
#     )
#     email = filters.CharFilter(field_name="showroom__email", lookup_expr="exact")
#     added_date = filters.DateFilter(
#         field_name="showroom__added_date", lookup_expr="exact"
#     )
#     date_updated = filters.DateFilter(
#         field_name="showroom__date_updated", lookup_expr="exact"
#     )
