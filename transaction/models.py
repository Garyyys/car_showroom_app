...
class SaleShowroomToBuyer(DateAdded, models.Model):
    id_showroom = models.ForeignKey('showroom.Showroom', on_delete=models.PROTECT, related_name="sales_buyers_id_showroom")
