...
class DealerViewSet(CustomViewSet):
    ...
    def detail_of_dealer(self, request, pk):
        ...
        return Response(
            {"dealer details": DealerSerializer(dealer_detail).data},
    ...
    def create_dealer(self, request):
        ...
        return Response({"New dealer detail": dealer_serializer.data}, status=status.HTTP_201_CREATED)
...
class DealerCarForSaleViewSet(CustomViewSet):
    """
    A viewset for information about suppliers and theirs cars
    """
